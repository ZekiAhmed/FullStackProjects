...
const PostInteractions = ({ count, postId, isLiked, isRePosted, isSaved }: { count: { likes: number; rePosts: number; comments: number }; postId: number; isLiked: boolean; isRePosted: boolean; isSaved: boolean }) => {
